const SAMPLE_QUESTIONS = [
  ...
  },
  {
    ...
    definition: 'Pathognomonic oral lesions consisting of small white spots with red halos on the buccal mucosa.',
    hallmark_features: [
    ...
    exam_pearl: 'Koplik spots are virtually diagnostic of measles and appear BEFORE the rash.',
    pitfall: 'Students often forget to look for Koplik spots and miss the diagnosis in the prodromal phase.'
  },
  {
    id: 'q3',
    ...
    options: ['Pneumonia caused by Streptococcus pneumoniae', 'Tuberculosis', 'Lung cancer', 'Sarcoidosis'],
    definition: 'A chronic infectious disease caused by Mycobacterium tuberculosis, classically presenting with cavitary lesions in the upper lobes.',
    hallmark_features: [
    ...
    exam_pearl: 'Upper lobe cavitary disease with night sweats is classic tuberculosis until proven otherwise.',
    pitfall: 'Secondary TB (reactivation) can present atypically in immunocompromised patients.'
  },
  {
    id: 'q4',
    question_type: 'triad',
    ...
    difficulty_level: 2,
    accepted_answers: ['ascending cholangitis', 'acute cholangitis', 'cholangitis'],
    definition: 'Infection of the bile ducts with stasis and obstruction. This is a medical emergency.',
    hallmark_features: [
    ...
    exam_pearl: 'Charcot triad (fever, RUQ pain, jaundice) is pathognomonic for ascending cholangitis.',
    pitfall: 'Not all patients present with the full triad; high suspicion needed with any two features.'
  },
  {
    id: 'q5',
    question_type: 'pathognomonic',
    ...
    definition: 'Linear hemorrhages beneath the nails that appear as thin red or black lines running with the long axis of the nail.',
    hallmark_features: [
    ...
    exam_pearl: 'Splinter hemorrhages are a classic stigma of endocarditis, but trauma is more common.',
    pitfall: 'Overinterpretation: splinter hemorrhages from trauma are much more common than from endocarditis.'
  },
  {
    id: 'q6',
    question_type: 'triad',
  ...
  },
  {
    ...
    options: ['Pyloric stenosis', 'Duodenal atresia', 'Gastroesophageal reflux', 'Intestinal atresia'],
  ...
  },
  {
    ...
    options: ['Asthma', 'Mesothelioma', 'Pneumonia', 'Tuberculosis'],
  ...
  },
  {
    ...
    options: ['Gastric ulcer', 'Acute pancreatitis', 'Acute cholecystitis', 'Appendicitis'],
  ...
  },
  {
    ...
    options: ['Peptic ulcer disease', 'GERD', 'Crohn disease', 'Esophageal cancer'],
